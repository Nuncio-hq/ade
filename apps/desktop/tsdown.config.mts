...
const sourcemapEnv = process.env.NUNCIO_DESKTOP_SOURCEMAP?.trim().toLowerCase();
...
export default defineConfig([
  {
    ...
    define: {
      __NUNCIO_WINDOWS_UPDATER_PUBLISHER__: JSON.stringify(windowsUpdaterPublisher),
    },
    noExternal: (id) => id.startsWith("@nuncio/"),
  },
  {
    ...shared,
