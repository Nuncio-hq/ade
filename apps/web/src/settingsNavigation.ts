...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  },
  {
    ...
    group: "personal",
    label: "Notifications",
    description: "Choose how NuncioADE tells you when work finishes or needs attention.",
    icon: "bell",
    eyebrow: "Alerts",
  },
  {
  ...
  },
  {
    ...
    description: "Give Codex, Claude, and other local agents scoped access to NuncioADE tasks.",
    icon: "plugin-1",
  ...
  },
  {
    ...
    description: "Review and clean up isolated workspaces created by NuncioADE.",
    icon: "branch-simple",
