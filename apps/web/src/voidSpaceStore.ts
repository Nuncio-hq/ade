...
// Layer: Web UI state
// Why: "Void" is NuncioADE's word for "not filed yet", and it is the one Space label a user
...
import { SPACE_NAME_MAX_LENGTH } from "@nuncio/contracts";
...
const STORAGE_KEY = "nuncioade:void-space:v1";
