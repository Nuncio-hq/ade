...
// Purpose: Detects when a normal chat prompt is actually asking NuncioADE to create an automation.
...
import { completionPolicyFromStopWhen } from "@nuncio/shared/automationCompletionPolicy";
