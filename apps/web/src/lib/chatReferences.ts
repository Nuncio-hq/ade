...
import { CHAT_ASSISTANT_SELECTION_TEXT_MAX_CHARS, type ThreadId } from "@nuncio/contracts";
...
export const CHAT_FILE_REFERENCE_DRAG_TYPE = "application/x-nuncioade-file-reference";
