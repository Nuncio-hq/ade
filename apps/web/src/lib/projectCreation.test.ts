...
const WORKSPACE_ROOT = "/Users/tester/Developer/nuncioade";
...
describe("createOrRecoverProjectFromPath", () => {
  ...
  it("recovers the existing project when project.create reports a duplicate workspace root", async () => {
    ...
    const dispatchCommand = vi.fn(async () => {
      throw new Error(
        "Orchestration command invariant failed (project.create): Project 'project-existing' already uses workspace root '/Users/tester/Developer/nuncioade'.",
      );
    });
