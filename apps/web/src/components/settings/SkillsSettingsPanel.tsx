...
// catalog (~/.nuncioade/skills plus each provider's skills folder), shows which provider
...
import type { ProviderKind, ServerSettings } from "@nuncio/contracts";
...
export function SkillsSettingsPanel() {
  ...
  const nuncioadeSkillsDir = catalogQuery.data?.nuncioadeSkillsDir;

  return (
    <div className="space-y-8">
      <SettingsSection title="Portable skills">
        <SettingsRow
          title="NuncioADE skills folder"
      ...
      {catalogQuery.isError ? (
        <SettingsSection title="Skills">
          <SettingsRow
            ...
            description="NuncioADE could not scan the skill folders. Retry after checking that the server is running."
          />
        </SettingsSection>
      ) : null}
      ...
      {!catalogQuery.isLoading && !catalogQuery.isError && totalSkills === 0 ? (
        <SettingsSection title="Skills">
          <SettingsRow
            ...
            description="Add a skill folder containing a SKILL.md to the NuncioADE skills folder above, or install skills for any supported provider."
          />
        </SettingsSection>
      ) : null}
