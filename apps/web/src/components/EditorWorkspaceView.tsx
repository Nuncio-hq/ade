...
import type { ProjectId } from "@nuncio/contracts";
...
const EDITOR_CHAT_PANE_STORAGE_KEY = "nuncioade.editor.chatPaneWidth";
const EDITOR_SIDEBAR_VISIBLE_STORAGE_KEY = "nuncioade.editor.sidebarVisible";
const EDITOR_CHAT_PANE_VISIBLE_STORAGE_KEY = "nuncioade.editor.chatPaneVisible";
