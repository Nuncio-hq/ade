...
//          control GitPanel so they share font/theme behavior, the NuncioADE file
...
// A single themed file diff with NuncioADE's custom file header. Bakes in the shared
