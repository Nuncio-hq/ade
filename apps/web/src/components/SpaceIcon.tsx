// FILE: SpaceIcon.tsx
// Purpose: Renders built-in and custom Space icons through NuncioADE's Central asset renderer.

import { SPACE_ICON_NAMES, type SpaceIconName } from "@nuncio/contracts";
