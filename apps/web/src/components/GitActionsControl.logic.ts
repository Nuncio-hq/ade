...
import { isTemporaryWorktreeBranch, resolveUniqueNuncioADEBranchName } from "@nuncio/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueNuncioADEBranchName(existingBranchNames, preferredBranch);
}
...
export { resolveAutoFeatureBranchName } from "@nuncio/shared/git";
