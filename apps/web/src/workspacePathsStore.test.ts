...
describe("workspacePathsStore", () => {
  ...
  it("keeps chat workspace root while server config is still loading", async () => {
    ...
    useWorkspacePathsStore.getState().setChatWorkspaceRoot("/Users/tester/Documents/NuncioADE");
    ...
    expect(useWorkspacePathsStore.getState().chatWorkspaceRoot).toBe(
      "/Users/tester/Documents/NuncioADE",
    );
  });
  ...
  it("keeps studio workspace root while server config is still loading", async () => {
    ...
    useWorkspacePathsStore
      .getState()
      .setStudioWorkspaceRoot("/Users/tester/Documents/NuncioADE/Studio");
    ...
    expect(useWorkspacePathsStore.getState().studioWorkspaceRoot).toBe(
      "/Users/tester/Documents/NuncioADE/Studio",
    );
  });
  ...
  it("migrates cached paths without retaining legacy workspace pages", async () => {
    ...
    localStorage.setItem(
      "nuncioade:workspace-pages:v2",
      JSON.stringify({
        state: {
          homeDir: "/Users/legacy",
          chatWorkspaceRoot: "/Users/legacy/Documents/NuncioADE",
    ...
    expect(useWorkspacePathsStore.getState().chatWorkspaceRoot).toBe(
      "/Users/legacy/Documents/NuncioADE",
    );
    ...
    expect(localStorage.getItem("nuncioade:workspace-pages:v2")).toBeNull();
    expect(localStorage.getItem("nuncioade:workspace-paths:v1")).not.toBeNull();
  });
});
