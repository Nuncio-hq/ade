...
const logPath = process.env.NUNCIO_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.NUNCIO_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "nuncioade-official-sdk-conformance-agent" })
