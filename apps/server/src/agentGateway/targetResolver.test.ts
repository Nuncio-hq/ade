...
import type { ModelSelection, ProviderKind, ProviderModelDescriptor } from "@nuncio/contracts";
...
describe("agent gateway target resolver", () => {
  ...
  it.effect("fails closed before discovery when NuncioADE disables a provider", () =>
    Effect.gen(function* () {
