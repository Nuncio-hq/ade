/**
 * AgentGateway - NuncioADE app-control tool surface for provider agents.
 *
 * Serves the `nuncioade_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control NuncioADE itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "nuncioade/agentGateway/Services/AgentGateway",
) {}
