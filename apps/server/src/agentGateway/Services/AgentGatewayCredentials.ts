/**
 * AgentGatewayCredentials - Per-session credentials for the NuncioADE agent
 * gateway.
 *
...
export interface AgentGatewayCredentialsShape {
  /** Streamable-HTTP MCP endpoint served by this NuncioADE instance. */
...
>()("nuncioade/agentGateway/Services/AgentGatewayCredentials") {}
