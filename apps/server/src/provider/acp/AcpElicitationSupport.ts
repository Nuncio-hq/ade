...
// Purpose: Bridges ACP form elicitation schemas to NuncioADE's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by NuncioADE's composer.
