...
import type { ChatAttachment, ProviderKind, ThreadId } from "@nuncio/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("nuncioade.providerAttachmentStoragePath");
