...
import { EDITOR_ICON_ROUTE_PATH } from "@nuncio/shared/editorIcons";
        ...
        return HttpServerResponse.jsonUnsafe(
          { error: authorization.reason === "unavailable" ? "Not Found" : "Unauthorized" },
          {
            ...
            ...(authorization.status === 401
              ? { headers: { "WWW-Authenticate": 'Bearer realm="nuncioade-desktop-shutdown"' } }
              : {}),
          },
        );
      }
...
const threadExportEffectRouteLayer = HttpRouter.add(
  ...
  Effect.gen(function* () {
    ...
    // app fetches cross-origin (nuncioade://app), and without them the browser masks
