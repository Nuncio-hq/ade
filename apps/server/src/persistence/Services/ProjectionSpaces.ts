...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@nuncio/contracts";
...
>()("nuncioade/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}
