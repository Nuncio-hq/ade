import { EventId, IsoDateTime, NonNegativeInt, ThreadId } from "@nuncio/contracts";
...
>()(
  "nuncioade/persistence/Services/OrchestrationEventDeliveries/OrchestrationEventDeliveryRepository",
) {}
