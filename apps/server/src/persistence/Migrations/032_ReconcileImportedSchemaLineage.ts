 ...
 * names. Because the migrator skips by ID, NuncioADE migrations 17-31 never run
 ...
 * NuncioADE migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh NuncioADE installs (every column already
