...
export const NUNCIO_CODEX_HOME_OVERLAY_DIR = "codex-home-overlay";
...
export function resolveNuncioADECodexHomeOverlayPath(
  env: NodeJS.ProcessEnv,
 ...
 * writes under. NuncioADE keeps its generated config isolated from the user's
...
export function resolveActiveCodexHomeWritePath(input: CodexHomePathsInput = {}): string {
  ...
  const overlay = resolveNuncioADECodexHomeOverlayPath(env, source);
