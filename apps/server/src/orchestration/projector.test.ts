      ...
      projectEvent(
        ...
        makeEvent({
          ...
          payload: {
            ...
            turnId: "turn-0",
            checkpointTurnCount: 1,
            checkpointRef: "refs/nuncioade/checkpoints/thread-1/turn/0",
            status: "ready",
            files: [],
      ...
      projectEvent(
        ...
        makeEvent({
          ...
          payload: {
            ...
            turnId: "turn-1",
            checkpointTurnCount: 1,
            checkpointRef: "refs/nuncioade/checkpoints/thread-1/turn/1",
            status: "ready",
            files: [],
            assistantMessageId: null,
    ...
    const events: ReadonlyArray<OrchestrationEvent> = [
      ...
      makeEvent({
        ...
        payload: {
          ...
          checkpointRef: "refs/nuncioade/checkpoints/thread-1/turn/2",
          status: "ready",
          files: [],
    ...
    const events: ReadonlyArray<OrchestrationEvent> = [
      makeEvent({
        ...
        payload: {
          ...
          turnId: "turn-1",
          checkpointTurnCount: 1,
          checkpointRef: "refs/nuncioade/checkpoints/thread-revert/turn/1",
          status: "ready",
          files: [],
      ...
      makeEvent({
        ...
        payload: {
          ...
          turnId: "turn-2",
          checkpointTurnCount: 2,
          checkpointRef: "refs/nuncioade/checkpoints/thread-revert/turn/2",
          status: "ready",
          files: [],
      ...
      (_, index) =>
        makeEvent({
          ...
          payload: {
            ...
            checkpointRef: `refs/nuncioade/checkpoints/thread-capped/turn/${index + 1}`,
            status: "ready",
            files: [],
