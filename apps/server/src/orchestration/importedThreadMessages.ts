...
// Purpose: Normalizes provider-native transcript snapshots into NuncioADE import messages.
...
import { MessageId, type ThreadHandoffImportedMessage, type ThreadId } from "@nuncio/contracts";
