...
describe("merge-mac-update-manifests", () => {
  it("merges ZIP-only arm64 and x64 updater manifests", () => {
    const arm64 = parseMacUpdateManifest(
      `version: 0.0.4
files:
  - url: NuncioADE-0.0.4-arm64.zip
    sha512: arm64zip
    size: 125621344
path: NuncioADE-0.0.4-arm64.zip
sha512: arm64zip
...
`,
    ...
    const x64 = parseMacUpdateManifest(
      `version: 0.0.4
files:
  - url: NuncioADE-0.0.4-x64.zip
    sha512: x64zip
    size: 132000112
path: NuncioADE-0.0.4-x64.zip
sha512: x64zip
...
`,
    ...
    assert.deepStrictEqual(
      ...
      ["NuncioADE-0.0.4-arm64.zip", "NuncioADE-0.0.4-x64.zip"],
    );
