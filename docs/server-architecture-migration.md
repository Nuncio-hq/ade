...
This document tracks compatibility constraints for the controlled migration from the current legacy NuncioADE-style server toward the newer upstream modular server architecture.
