# UPSTREAM-SYNC — pulling NuncioADE releases into NuncioADE

> Runbook for syncing from upstream NuncioADE. Written to be executable by an agent
...
- `UPSTREAM-BASE`: set to the merged NuncioADE tag (same commit as the merge).
