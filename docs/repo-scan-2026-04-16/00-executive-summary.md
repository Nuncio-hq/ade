...
- CI is not superficial. It already runs format, lint, typecheck, tests, browser tests, and desktop build verification in [`.github/workflows/ci.yml`](/Users/emanueledipietro/Developer/Testing/nuncioade/.github/workflows/ci.yml).
...
- [`apps/server/src/codexAppServerManager.ts`](/Users/emanueledipietro/Developer/Testing/nuncioade/apps/server/src/codexAppServerManager.ts)
- [`apps/server/src/wsServer.ts`](/Users/emanueledipietro/Developer/Testing/nuncioade/apps/server/src/wsServer.ts)
- [`apps/desktop/src/main.ts`](/Users/emanueledipietro/Developer/Testing/nuncioade/apps/desktop/src/main.ts)
...
There is useful release documentation in [`docs/release.md`](/Users/emanueledipietro/Developer/Testing/nuncioade/docs/release.md), but there is not yet a matching level of architecture guidance for:
