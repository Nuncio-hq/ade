...
// the shareable activity card. All metrics are backed by NuncioADE's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used NuncioADE.
...
// Token totals come from NuncioADE's projected context-window updates. `available`
