...
const PATH_CAPTURE_START = "__NUNCIO_PATH_START__";
const PATH_CAPTURE_END = "__NUNCIO_PATH_END__";
 ...
 */
export const SHELL_ENVIRONMENT_HYDRATED_ENV_NAME = "NUNCIO_PATH_HYDRATED";
...
function envCaptureStart(name: string): string {
  return `__NUNCIO_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__NUNCIO_ENV_${name}_END__`;
}
